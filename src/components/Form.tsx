...
const schema= yup.object({
        num_bureau: yup.number().typeError("veuillez entrer un numéro").positive("numéro de bureau doit ètre positive").integer("veuillez entrer un entier").required("numéro de bureau requis"),
        extra_s1: yup.number().typeError("veuillez entrer un numéro").positive("numéro de bureau doit ètre positive").integer("veuillez entrer un entier"),
        extra_s2: yup.number().typeError("veuillez entrer un numéro").positive("numéro de bureau doit ètre positive").integer("veuillez entrer un entier"),
    }).required();
function Form() {
...
{/*<div className="section">
            ...
            <div className="section">
                ...
                <input {...register("num_bureau")} type="text" name="num_bureau"/>
                {errors.num_bureau && <p className="text-red-500">{errors.num_bureau.message}</p>}
            </div>
            <div className="section">
...
{extra_s1 =="extra_s1" &&(<motion.div layout initial={{ y:-10,opacity:0}} animate={{y:0,opacity:1}} exit={{ y:-10,opacity:0}} transition={{duration: 0.2}} className="section shadow rounded-xl  "> 
...
<AnimatePresence >
{extra_s2 =="extra_s2" &&(<motion.div layout initial={{ y:-10,opacity:0}} animate={{y:0,opacity:1}} exit={{ y:-10,opacity:0}} transition={{duration: 0.2,ease:"easeInOut"}} className="section rounded-xl p-4 shadow overflow-hidden">
